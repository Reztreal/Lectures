                ...
                switch(base)
                {
                    ...
                    case 2:
                        while(txCode != '\n')
                        {
                            ...
                            {
                                for(scTemp=scBin,counter=0, digit=1; counter<8; counter++) // binary xor secredcode(scTemp) 
                                {
                                    if((scTemp%10) != (binary%10)) 
                                        binCh += digit;
                                ...
                                for(base=0,digit=1;binCh > 0;) // XORed binary to decimal
                                {
                                    base += (binCh%10)*digit;
                                    digit*=2;
                                    binCh/=10;
